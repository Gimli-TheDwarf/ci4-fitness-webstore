<div class="w-100">
    <div class="homepage-filter-toolbar bg-white border shadow-sm rounded-2 p-3 d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 w-100">
        <div class="d-flex align-items-center gap-2 text-blue-gray">
            ...
            <div>
                <h1 class="h5 fw-semibold mb-0">Sales</h1>
                <span class="small text-secondary">Sales reporting will appear here.</span>
            </div>
        </div>
        <span class="badge rounded-pill bg-secondary-subtle text-secondary-emphasis border">Coming soon</span>
    </div>
</div>
