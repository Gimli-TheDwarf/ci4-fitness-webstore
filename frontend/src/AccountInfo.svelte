        ...
        <div class="bg-white rounded-2 shadow-sm border overflow-hidden">
            ...
            <div class="row g-3 p-4">
                <div class="col-12 col-md-6">
                    ...
                    <input data-target="username" value={accountInformation.username} placeholder={accountInformation?.username ? accountInformation.username : "No username provided"} class:opacity-75={!accountInformation.username} id="username-input" class="rounded-1 border form-control shadow-sm" type="text">
                </div>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input data-target="email" value={accountInformation.email} placeholder={accountInformation?.email ? accountInformation.email : "No email provided"} class:opacity-75={!accountInformation.email} id="email-input" class="rounded-1 border form-control shadow-sm" type="text">
                </div>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input data-target="phone" value={accountInformation.phone} placeholder={accountInformation?.phone ? accountInformation.phone : "No phone provided"} class:opacity-75={!accountInformation.phone} id="phone-input" class="rounded-1 border form-control shadow-sm" type="text">
                </div>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input data-target="full_name" value={accountInformation.full_name} placeholder={accountInformation?.full_name ? accountInformation.full_name : "No full name provided"} class:opacity-75={!accountInformation.full_name} id="full-name-input" class="rounded-1 border form-control shadow-sm" type="text">
                </div>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input data-target="address" value={accountInformation.address} placeholder={accountInformation?.address ? accountInformation.address : "No address provided"} class:opacity-75={!accountInformation.address} id="address-input" class="rounded-1 border form-control shadow-sm" type="text">
                </div>
